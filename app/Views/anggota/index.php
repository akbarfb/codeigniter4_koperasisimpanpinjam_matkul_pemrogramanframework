...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            ...
            <p>Menyimpan informasi anggota koperasi.</p>
                    ...
                    <?php if(!empty($anggota)): ?>
                        <?php foreach($anggota as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="anggota/edit/<?= $row['id_anggota']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="anggota/delete/<?= $row['id_anggota']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
