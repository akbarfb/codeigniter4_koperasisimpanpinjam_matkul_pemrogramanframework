...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            <h2>Data Angsuran</h2>
            <p>Data Angsuran Pembayaran Pinjaman.</p>
            <a href="angsuran/create" class="btn btn-success mb-3">Tambah Data Angsuran</a>
                    ...
                    <?php if (!empty($angsuran)) : ?>
                        <?php foreach ($angsuran as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['status']; ?></td>
                                <td>
                                    <a href="angsuran/edit/<?= $row['id_angsuran']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="angsuran/delete/<?= $row['id_angsuran']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
                        <tr>
                            <td colspan="7">Tidak ada data angsuran.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
