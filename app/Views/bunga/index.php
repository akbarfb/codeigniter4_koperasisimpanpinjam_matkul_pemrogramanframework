...
<body>
    ...
    <nav class="sidebar">
        <div class="container-fluid">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a id="bungaLink" class="nav-link" href="bunga"><i class="fas fa-percent"></i> BUNGA</a>
                </li>               
            </ul>
        </div>
    </nav>
    ...
    <div class="main-content">
        <div class="table-container">
            <h2>Data Bunga</h2>
            <a href="bunga/create" class="btn btn-success mb-3">Tambah Bunga</a>
                    ...
                    <?php if(!empty($bunga)): ?>
                        <?php foreach($bunga as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="bunga/edit/<?= $row['id_bunga']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="bunga/delete/<?= $row['id_bunga']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="7">Tidak ada data bunga.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
