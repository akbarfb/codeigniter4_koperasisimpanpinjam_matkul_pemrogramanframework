...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            ...
            <p>Menampilkan data transaksi anggota.</p>
                    ...
                    <?php if(!empty($transaksi)): ?>
                        <?php foreach($transaksi as $row): ?>
                            <tr>
                                ...
                                <td><?= $row['tanggal']; ?></td>
                                <td>
                                    <a href="/transaksi/edit/<?= $row['id_transaksi']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="/transaksi/delete/<?= $row['id_transaksi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (currentPath === 'home') {
                ...
                setActiveLink('simpanan_wajib');
            } else if (currentPath === 'simpanan_pokok') {
                setActiveLink('simpanan_pokok');
