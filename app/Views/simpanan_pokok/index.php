...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            <h2>Data Simpanan Pokok</h2>
            <p>Menyimpan data simpanan pokok anggota.</p>
            <a href="simpanan_pokok/create" class="btn btn-success mb-3">Tambah Simpanan Pokok</a>
            <table class="table table-striped">
                ...
                <tbody>
                    <?php if(!empty($simpanan_pokok)): ?>
                        <?php foreach($simpanan_pokok as $row): ?>
                            <tr>
                                <td><?= $row['id_simpanan_pokok']; ?></td>
                                <td><?= $row['id_anggota']; ?></td>
                                
                                <td><?= $row['jumlah']; ?></td>
                                <td><?= $row['tanggal']; ?></td>
                                <td>
                                    <a href="simpanan_pokok/edit/<?= $row['id_simpanan_pokok']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="simpanan_pokok/delete/<?= $row['id_simpanan_pokok']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="7">Tidak ada data simpanan pokok.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
